...
def bill():
    ...
    top.title('Bill')
    Label(top,text='ROYAL CLIFF',font=("Castellar",20)).grid(row=0,column=2,columnspan=3)
    Label(top).grid(row=2,column=1)
    Label(top,text='Date',font=('Castellar',14)).grid(row=3,column=1)#date
    Label(top,text=str(today),font=('Castellar',14)).grid(row=4,column=1)#date
    Label(top,text='Bill No.',font=('Castellar',14)).grid(row=3,column=3)#billno
    Label(top,text=str(b),font=('Castellar',14)).grid(row=4,column=3)#billno
    Label(top).grid(row=5,column=1)
    Label(top,text='Items',font=("Castellar",14)).grid(row=6,column=1)#items
    Label(top,text='Price',font=('Castellar',14)).grid(row=6,column=2)#price
    Label(top,text='Quantity',font=('Castellar',14)).grid(row=6,column=3)#Quantity
    Label(top).grid(row=7,column=1)
